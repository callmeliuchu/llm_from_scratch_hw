...
def run_multihead_self_attention(
    ...
    mla = MultiHeadSelfAttention(d_model=d_model,num_heads=num_heads)
    mla.WQ.weight.data = q_proj_weight
    mla.WK.weight.data = k_proj_weight
    mla.WV.weight.data = v_proj_weight
    mla.out.weight.data = o_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    mla = MultiHeadSelfAttentionRope(d_model=d_model,num_heads=num_heads,theta=theta,max_seq_len=max_seq_len)
    mla.WQ.weight.data = q_proj_weight
    mla.WK.weight.data = k_proj_weight
    mla.WV.weight.data = v_proj_weight
    mla.out.weight.data = o_proj_weight
    return mla(in_features,token_positions)
...
def run_rope(
    ...
    """
    # raise NotImplementedError
    from transformer import RotaryPositionalEmbedding
...
def run_transformer_block(
    ...
    block.mha.out.weight.data = weights['attn.output_proj.weight']
    block.rms1.weight.data = weights['ln1.weight']
    block.fn.W1.data = weights['ffn.w1.weight']
    block.fn.W2.data = weights['ffn.w2.weight']
    block.fn.W3.data = weights['ffn.w3.weight']
...
def run_get_batch(
    ...
    """
    # raise NotImplementedError
    from transformer import get_batch
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    # raise NotImplementedError
    from transformer import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    # raise NotImplementedError
    from transformer import get_lr_cosine_schedule
...
def run_load_checkpoint(
    ...
    """
    from transformer import load_checkpoint
